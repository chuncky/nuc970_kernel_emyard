...
dhd_conf_set_fw_name_by_chip(dhd_pub_t *dhd, char *fw_path)
{
	...
	{
		bcm_strncpy_s(fw_path, MOD_PARAM_PATHLEN-1, CONFIG_BCMDHD_FW_HOSTAP_PATH, MOD_PARAM_PATHLEN-1);
	}
	else
	{
	...
	printf("firmware path is %s op_mode=%d\r\n",CONFIG_BCMDHD_FW_HOSTAP_PATH,op_mode);
		if (fw_path[0] == '\0')
#endif
		{
